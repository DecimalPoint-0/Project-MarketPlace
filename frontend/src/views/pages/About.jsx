                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                        <div>
                            ...
                            <div className="flex gap-4">
                                <Link to="/signup" className="btn px-8 py-3 font-semibold">
                                    Join Us Today
                                </Link>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-12 border border-slate-200">
                            ...
                            <ul className="space-y-3">
                                ...
                                <li className="flex gap-3 items-start">
                                    <i className="fas fa-check text-primary text-xl mt-0.5"></i>
                                    <span className="text-slate-600">Build a trusted marketplace for researchers</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 border border-slate-200">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">support@marketplace.com</p>
                                    </div>
                                </div>
                            </div>
