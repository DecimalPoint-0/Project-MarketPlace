            ...
            <section className="hero min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-50">
                ...
                <div className="hero-content container max-w-6xl mx-auto px-8 text-center z-10 animate-slideUp">
                    <h1 className="text-5xl md:text-6xl font-bold text-light mb-6 leading-tight">
                        Access Premium <span className="text-gradient">Project Materials</span>
                    </h1>
                ...
                <div className="container max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                            {categories?.map((cat) => (
                                <Link 
                                    ...
                                    className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-lg hover:border-primary transition-all group"
                                >
                                    <div className="flex items-start justify-between mb-6">
                                        <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition">
                                    ...
                                    <h3 className="text-xl font-bold text-primary mb-3 group-hover:text-primary/80 transition">
                                        {cat?.title}
                                    </h3>
                                    <p className="text-slate-600 mb-6">
                                        {cat?.project_count ?? 0} Projects Available
                                    </p>
                                    <div className="flex items-center text-primary group-hover:translate-x-1 transition-transform font-semibold">
                                        <span>View All</span>
                        ...
                        {(categoryPagination.previous || categoryPagination.next) && (
                            <div className="flex justify-center gap-4">
                                <button
                                    ...
                                    className="px-6 py-2 border border-slate-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 transition"
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={step.num} className="text-center">
                                    <div className="w-16 h-16 bg-blue-100 text-primary rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 group hover:bg-primary hover:text-white transition">
                                        {step.num}
                                    </div>
                    ...
                    <div className="mb-32 bg-gradient-primary text-white rounded-2xl p-16">
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <Link to="/sign-up/" className="inline-block bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition">
                                    Start Earning
                                </Link>
                            </div>
                    ...
                    <div className="mb-32">
                        ...
                        <div className="space-y-4 mb-12">
                            {faqs?.map((f, idx) => (
                                <div key={idx} className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-md transition">
